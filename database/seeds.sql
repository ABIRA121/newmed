...
-- Insert admin user (temporary password: TempPass123!)
INSERT INTO users (role, email, password_hash, full_name, phone, created_at, is_active, password_change_required) VALUES
('admin', 'admin@medportal.com', '$2y$10$rOzZMSR5pJ.6U6Z8X8qB.uJcJdJkS9qJcJdJkS9qJcJdJkS9qJcJdJ', 'System Administrator', '+1234567890', NOW(), TRUE, TRUE);

-- Insert clinical staff (temporary password: TempPass123!)
INSERT INTO users (role, email, password_hash, full_name, phone, created_at, is_active, password_change_required) VALUES
...
-- Insert patient users (temporary password: TempPass123!)
INSERT INTO users (role, email, password_hash, full_name, phone, created_at, is_active, password_change_required) VALUES
